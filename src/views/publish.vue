  ...
  <div class="container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :offset="2" :span="16">
        <!-- 主体内容 -->
        <div class="publish">
          <el-alert v-if="news.id != 0" title="修改文章" type="success" :closable="false"></el-alert>
      ...
      <el-col :span="6" class="right">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <el-button type="success" plain @click="btnOption('save')">保存为草稿</el-button>
          ...
          <div class="hot_list">
            <el-form :model="news">
              ...
              <!-- 标签选择 -->
              <el-checkbox-group v-model="selectedTags" :min="1" :max="5" @change="getSelectedTags">
                <el-checkbox v-for="tag in tags" :label="String(tag.id)" :key="tag.id">{{tag.name}}</el-checkbox>
              </el-checkbox-group>
            </el-form>
          </div>
        </el-card>
