  ...
  <el-card>
    ...
    <p>
      ...
      <el-button
        style="float: right"
        type="text"
        @click="updateCheckedStatus(0)"
        >全部已读({{ uncheckCount }})</el-button
      >
    </p>
    <el-timeline>
      <el-timeline-item
        ...
        <el-card>
          <span style="float: right" type="text">
            <el-link
              type="primary"
              v-if="item.checked"
              @click="updateCheckedStatus(item.id)"
              >标记为未读</el-link
            >
            <el-link
              type="primary"
            ...
            >
            /
            <el-link type="danger" @click="deleteNotice(item.id)">删除</el-link>
          </span>
          <p>
            <el-badge is-dot :hidden="item.checked">
          ...
          <el-card v-if="item.type == 1 || item.type == 2">
            <span class="content">
              {{ item.object.title }}
            </span>
          </el-card>
