<template>
  <el-main>
    <el-card>
      ...
      <div class="content">
        <el-timeline>
          <el-timeline-item v-for="item in traceList"
                            :key="item.id"
            ...
            <el-card>
              ...
              <el-card v-if="item.type <= 3">
                ...
                <p style="text-align: right">
                  <span v-for="tags in item.object.tagsList"
              ...
              <el-card v-if="item.type == 4">
                <span @click="getNew(item.object.newsId)"
                      class="comment">
                  {{ item.object.content }}
                </span>
              </el-card>
              <!-- 留言对象 -->
              <el-card v-if="item.type == 5"
                       class="board">
                {{ item.object.content }}
